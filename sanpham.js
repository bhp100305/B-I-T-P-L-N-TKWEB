document.addEventListener("DOMContentLoaded", function () {
  ...
  function displayCart() {
    ...
    cart.forEach((item) => {
      ...
      listItem.innerHTML = `
              ...
              ${
                item.name
              } - ${item.price.toLocaleString()} đ x <span class="quantity">${
        item.quantity
      }</span> =
              ${itemTotal.toLocaleString()} đ
              <button class="decrease" onclick="updateQuantity('decrease', '${
                item.id
              }')">-</button>
              <button class="increase" onclick="updateQuantity('increase', '${
                item.id
              }')">+</button>
              <span class="remove" onclick="removeFromCart('${
                item.id
              }')">Xóa</span>
          `;
  ...
  // Sự kiện mua hàng trong giỏ hàng
  document
